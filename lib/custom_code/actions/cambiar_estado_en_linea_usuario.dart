...
Future cambiarEstadoEnLineaUsuario(String? authUserId) async {
  ...
  try {
    ...
    await usuarioRef.update({'estado': 'En línea'});

    print('Estado del usuario actualizado a "en línea" correctamente.');
  } catch (e) {
