...
class PaginaProductoDetallesWidget extends StatefulWidget {
  const PaginaProductoDetallesWidget({super.key});
                              ...
                              child: Stack(
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/guitarra_acustica_3.png',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.fill,
                                    ),
                              ...
                              child: Stack(
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/guitarra_acustica_2.jpg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.fill,
                                    ),
                              ...
                              child: Stack(
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/guitarra_acustica_1.jpg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.fill,
                                    ),
                    ...
                    children: [
                      Flexible(
                        child: Align(
                          ...
                          child: Text(
                            'Fecha publicación: hace un momento',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Readex Pro',
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('paginaInformacionVendedor');
                            },
                            child: Container(
                              width: 100.0,
