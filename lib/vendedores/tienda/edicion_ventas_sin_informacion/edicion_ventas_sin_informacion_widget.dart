...
import 'edicion_ventas_sin_informacion_model.dart';
export 'edicion_ventas_sin_informacion_model.dart';

class EdicionVentasSinInformacionWidget extends StatefulWidget {
  const EdicionVentasSinInformacionWidget({
    super.key,
    required this.lista,
  });

  final ListasRecord? lista;

  @override
  State<EdicionVentasSinInformacionWidget> createState() =>
      _EdicionVentasSinInformacionWidgetState();
}

class _EdicionVentasSinInformacionWidgetState
    extends State<EdicionVentasSinInformacionWidget> {
  late EdicionVentasSinInformacionModel _model;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ListasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ListasRecord> edicionVentasSinInformacionListasRecordList =
            snapshot.data!;
